...
},
{
    ...
    keywords: [
        "能量", "能源", "能量來源", "再生能源", "非再生能源",
        "太陽能", "風能", "水力發電", "水力能",
        "煤", "石油", "天然氣", "化石燃料",
        "電力", "熱能", "光能", "聲能", "肌肉能量",
        "energy", "energy source", "energy sources",
        "renewable energy", "renewable energy sources",
        "non-renewable energy", "non-renewable energy sources",
        "solar energy", "solar power", "wind energy", "wind power",
        "hydroelectric power", "hydropower",
        "coal", "oil", "natural gas", "fossil fuels",
        "electricity", "heat energy", "light energy",
        "sound energy", "muscle energy", "clean energy",
        "What is energy",
    ...
    file: "images/english/energy-and-energy-sources-basics.png",
    alt: "Energy & Energy Sources 能量與能源英文教學圖，呈現能量的基本概念、再生與非再生能源、太陽能、風能、水力發電、煤、石油與天然氣，以及日常生活中的電力、熱能、光能與聲能等基礎科學概念",
    category: "english",
    grade: 7,
    chapter: "Energy & Energy Sources 能量與能源",
    concept: "能量、能源、再生能源、非再生能源、太陽能、風能、水力發電、化石燃料與日常生活中的能量應用英文",
    difficulty: 1,
    related: []
},
{
    ...
    keywords: [
        ...
        "礦物特性", "硬度", "晶體", "晶體結構",
        "石英", "黃金", "雲母", "方解石", "長石", "鐵礦",
        "rock", "rocks", "rock types", "rocks and minerals",
        "mineral", "minerals", "igneous rock", "igneous rocks",
        "sedimentary rock", "sedimentary rocks",
        "metamorphic rock", "metamorphic rocks",
        "granite", "basalt", "sandstone", "marble",
        "mineral properties", "hardness", "crystal", "crystal structure",
        "quartz", "gold", "mica", "calcite", "feldspar", "iron",
        "What is a rock",
        "What are rocks",
        "What is a mineral",
        "What are minerals",
    ...
    file: "images/english/rocks-and-minerals-basics.png",
    alt: "Rocks & Minerals 岩石與礦物英文教學圖，呈現岩石與礦物的基本概念、火成岩、沉積岩與變質岩，以及礦物的硬度、晶體結構與石英、黃金、雲母、方解石和長石等常見礦物",
    category: "english",
    grade: 7,
    chapter: "Rocks & Minerals 岩石與礦物",
    concept: "岩石、礦物、三大岩石類型、礦物特性、常見礦物與岩石形成英文",
    difficulty: 1,
    related: []
},
{
    id: "rocks-and-minerals-overview",
    title: "Rocks & Minerals Overview 岩石與礦物科普",
    keywords: [
        "岩石科普", "礦物科普", "岩石與礦物科普",
        "岩石介紹", "礦物介紹", "岩石概念", "礦物概念",
        "岩石循環", "岩石形成", "礦物特性",
        "三大岩石", "火成岩", "沉積岩", "變質岩",
        "rock overview", "rocks overview",
        "mineral overview", "minerals overview",
        "rocks and minerals overview",
        "rock cycle", "rock formation",
        "types of rocks", "three types of rocks",
    ...
    file: "images/english/rocks-and-minerals-overview.png",
    alt: "Rocks & Minerals Overview 岩石與礦物科普英文教學圖，介紹岩石與礦物、三大岩石類型、礦物特性與岩石循環",
    category: "english",
    grade: 7,
    chapter: "Rocks & Minerals 岩石與礦物",
    concept: "岩石與礦物科普、三大岩石類型、礦物特性與岩石循環英文",
    difficulty: 1,
    related: []
},
{
    id: "solar-system-and-space-exploration-basics",
    title: "The Solar System & Space Exploration 太陽系與太空探索",
    keywords: [
        "太陽系", "太陽", "八大行星", "行星",
        "水星", "金星", "地球", "火星",
        "木星", "土星", "天王星", "海王星",
        ...
        "火箭", "太空船", "太空飛行器", "太空人",
        "人造衛星", "衛星通訊",
        "solar system", "the solar system", "sun", "planet", "planets",
        "Mercury", "Venus", "Earth", "Mars",
        "Jupiter", "Saturn", "Uranus", "Neptune",
        "moon", "moons", "satellite", "satellites",
        "space", "space exploration", "space exploration technology",
        "space travel", "space mission", "space missions",
        "spacecraft", "spaceship", "rocket", "rockets",
    ...
    file: "images/english/solar-system-and-space-exploration-basics.png",
    alt: "The Solar System & Space Exploration 太陽系與太空探索英文教學圖，呈現太陽系、八大行星、火箭、人造衛星、太空船、太空人與太空探索的基本概念",
    category: "english",
    grade: 7,
    chapter: "The Solar System & Space Exploration 太陽系與太空探索",
    concept: "太陽系、八大行星、太空探索、火箭、人造衛星、太空船與太空人英文",
    difficulty: 1,
    related: []
},
{
...
{
    id: "cells-and-microorganisms-basics",
    title: "Cells & Microorganisms 細胞與微生物",
    keywords: [
        "細胞", "微生物", "細胞結構", "細胞膜",
        "細胞質", "細胞核", "粒線體",
        "生物基本單位", "生命基本單位",
        ...
        "mitochondria", "basic unit of life",
        "microorganism", "microorganisms",
        "microbe", "microbes",
        "bacteria", "virus", "viruses",
        "fungi", "fungus", "protists", "protist",
        "beneficial microorganisms", "microbial",
        "food fermentation", "decomposition",
        "What is a cell",
        "What are cells",
    ...
    file: "images/english/cells-and-microorganisms-basics.png",
    alt: "Cells & Microorganisms 細胞與微生物英文教學圖，呈現細胞基本結構、細菌、病毒、真菌與原生生物，以及微生物在食品、健康、環境與科學研究中的作用",
    category: "english",
    grade: 7,
    chapter: "Cells & Microorganisms 細胞與微生物",
    concept: "細胞、細胞結構、微生物種類及其作用英文",
    difficulty: 1,
    related: []
},
{
    ...
    keywords: [
        ...
        "地震影響", "地震安全", "地震避難",
        "火山地震", "海嘯",
        "earthquake", "earthquakes", "earthquake waves",
        "tectonic plates", "tectonic plate", "plate movement",
        "plate tectonics", "fault", "fault line",
        "epicenter", "focus", "seismic waves",
        "earthquake magnitude", "earthquake effects",
        "earthquake safety", "earthquake preparedness",
    ...
    file: "images/english/earthquakes-basics.png",
    alt: "Earthquakes 地震英文教學圖，呈現地震的基本概念、板塊運動、震央與震源、地震影響，以及地震發生時 Drop, Cover, and Hold On 的安全方式",
    category: "english",
    grade: 7,
    chapter: "Earthquakes 地震",
    concept: "地震、板塊運動、斷層、震央、震源、地震波、地震影響與安全英文",
    difficulty: 1,
    related: []
},
{
    ...
    title: "Volcanoes 火山",
    keywords: [
        "火山", "火山爆發", "火山噴發", "火山岩漿", "熔岩",
        "火山灰", "火山口", "火山通道", "火山類型",
        "盾狀火山", "複式火山",
        "volcano", "volcanoes", "volcanic", "volcanic eruption",
        "volcanic eruptions", "eruption", "erupt",
        "lava", "magma", "ash", "ash cloud", "crater", "vent",
        "shield volcano", "shield volcanoes",
        "stratovolcano", "stratovolcanoes",
        "volcano parts", "types of volcanoes",
    ...
    file: "images/english/volcanoes-basics.png",
    alt: "Volcanoes 火山英文教學圖，呈現火山的基本概念、火山結構、岩漿、熔岩、火山灰、火山口與火山通道，以及盾狀火山與複式火山",
    category: "english",
    grade: 7,
    chapter: "Volcanoes 火山",
    concept: "火山、火山爆發、火山結構、岩漿、熔岩、火山灰與火山類型英文",
    difficulty: 1,
    related: []
},
{
